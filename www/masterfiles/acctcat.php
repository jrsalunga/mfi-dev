...
<title>Modularfusion Inc - Items Category</title>
...
<script type="text/template" id="modal-acctcat-tpl">
...
<script type="text/template" id="modal-acctcat-readonly-tpl">
	<table cellpadding="5px" cellspacing="0" border="0">
	<tbody>
		<tr>
			<td>Code:</td>
...
$(document).ready(function(e) {
	...
	var acctcatModalView = new AcctcatModal({ model: acctcat});
	acctcatModalView.render();

	var acctcatDataGridView = new DataGridView({model: acctcat});

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		acctcatModalView.modalTitle.text('Add Record');
		acctcatModalView.clearForm();
	...
	oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../api/datatables/acctcat",
        	...
        	<nav class="main-nav">
            	<div id="menu0" class="nav active">
                    ...
                    <ul class="fd">
                    	...
                    	<li class="active"><a href="acctcat">Accounts Category</a></li>
