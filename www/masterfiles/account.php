...
<title>Modularfusion Inc - Item</title>
...
<script type="text/template" id="modal-account-tpl">
	<form id="frm-mdl-item" name="frm-mdl-item" class="table-model" data-table="item" action="" method="post">	
    	<table cellpadding="5px" cellspacing="0" border="0">
        	<tbody>
				...
				<tr>
                    <td><label for="acctcatid">Category:</label></td>
                    <td>
                        
                        <select name="acctcatid" id="acctcatid" class="m-input">
                        <?php
                           
                            
                            $matcats = Acctcat::find_all();
				...
				<tr>
                    ...
                    <td>
                        ...
                        <select name="type" id="type" class="m-input">
...
<script type="text/template" id="modal-account-readonly-tpl">
    ...
    <table cellpadding="5px" cellspacing="0" border="0">
            <tbody>
                ...
                <tr>
                    <td><label for="acctcat">Category: </label></td>
                    <td><input type="text" name="acctcat" id="acctcat" maxlength="20" class="m-input"  value="<%= acctcat %>"  readonly>     </td>
                </tr>
        		<tr>
                    <td><label for="type">Type: </label></td>
                    <td><input type="text" name="type" id="type" maxlength="20" class="m-input"  value="<%= type %>"  readonly>     </td>
                </tr>
            </tbody>
        </table>
    </form>
...
$(document).ready(function(e) {
	...
	var accountModal = new AccountModal({ model: account });

	accountModal.render();
	//console.log(itemcatModalView.el);
	var accountDataGridView = new DataGridView({model: account });

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		accountModal.modalTitle.text('Add Record');
	...
	oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../api/datatables/v/account",
