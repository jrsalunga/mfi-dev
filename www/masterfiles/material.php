...
<title>Modularfusion Inc - Material</title>
...
$(document).ready(function(e) {
	...
	$('#tlbr-new').on('click', function(){
		...
		material.clear().set(material.defaults);
	...
	//	"sAjaxSource": "../www/test/datatable_test.php"
		...
		"fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                ...
                $('td:eq(9)', nRow).addClass("currency").each(function(){
                    $(this).toCurrency();
                });
                
                $('td:eq(5),td:eq(6),td:eq(7), td:eq(8)', nRow).addClass("number");
        	}
    });
