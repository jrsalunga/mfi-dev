...
<title>Modularfusion Inc - Category Manager</title>
...
<script type="text/template" id="matcat-tpl">
	<div class="bb">
		<div class="Sj"></div>
		<div class="yb"></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="mdl-btn-save" class="btn btn-default" data-dismiss="modal">Cancel</button>
          <button type="button" id="mdl-btn-save" class="btn btn-primary" data-dismiss="modal">Save</button>
          <button type="button" is="mdl-btn-save-blank" class="btn btn-primary">Save &amp; Blank</button>
        </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
