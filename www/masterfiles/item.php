...
<script type="text/template" id="modal-item-tpl">
    	...
    	<table cellpadding="5px" cellspacing="0" border="0">
        	<tbody>
				...
				<tr>
                    ...
                    <td>
                        <!--
                        <input type="text" name="itemcatid" id="itemcatid" maxlength="50" class="m-input" value="<?='dshdhAH'?>">
                        -->
                        <select name="itemcatid" id="itemcatid" class="m-input">
                        <?php
                           
                            
                            $matcats = Itemcat::find_all();
...
<script type="text/template" id="modal-item-readonly-tpl">
    ...
    <table cellpadding="5px" cellspacing="0" border="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="itemcat" id="itemcat" maxlength="20" class="m-input"  value="<%= itemcat %>"  readonly>     </td>
                </tr>
...
$(document).ready(function(e) {
	...
	var itemModal = new ItemModal({ model: item });
    console.log(itemModal.el);
	itemModal.render();
	//console.log(itemcatModalView.el);
	var itemDataGridView = new DataGridView({model: item });

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		itemModal.modalTitle.text('Add Record');
		itemModal.clearForm();
	...
	oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../api/datatables/v/item",
