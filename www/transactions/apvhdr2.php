    	...
    	<table cellpadding="5px" cellspacing="0" border="0" >
        	<tbody>
            	<tr>
                  ...
                  <td><input type="text" name="refno" id="refno" maxlength="20" value="<%= refno %>" required></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="supprefno" id="supprefno" value="<%= supprefno %>"></td>
         		</tr>
				<tr>
                	<td><label for="porefno">PO Ref No:</label></td>
                    <td><input type="text" name="porefno" id="porefno" value="<%= porefno %>"></td>
				...
				<tr>
                    ...
                    <td><input type="text" name="totamount" id="totamount" class="currency" value="<%= totamount %>"></td>
					
					<td><label for="balance">Balance:</label></td>
                    <td><input type="text" name="balance" id="balance" class="currency" value="<%= balance %>"></td>
         		</tr>
        	</tbody>
    	</table>
 	</form>
...
<script type="text/template" id="modal-apvhdr-readonly-tpl">
	<form id="frm-mdl-apvhdr" name="frm-mdl-apvhdr" class="table-model" data-table="apvhdr" action="" method="post">	
    	<table cellpadding="5px" cellspacing="0" border="0" >
        	<tbody>
            	<tr>
                ...
                <tr>
                	<td><label for="supplierid">Supplier:</label></td>
                    <td><input type="text" name="supplierid" id="supplierid" value="<%= supplierid %>"></td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body-detail">
              ...
              <td>  
              Total Amount: <span id="f-total-amount" class="total float">0.00</span>
              </td></tr>
            ...
            <form class="modal-table-detail">
                    ...
                    <input type="number" name="amount" id="amount" pattern="^\d*(\.\d{1,2}$)?" >
